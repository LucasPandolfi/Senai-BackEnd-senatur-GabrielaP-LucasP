...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=DEV7\\SQLEXPRESS; Initial Catalog=Senatur_Tarde_; user Id=sa; pwd=sa@132;");
                //optionsBuilder.UseSqlServer("Data Source=DESKTOP_PCH001\\SQLEXPRESS; Initial Catalog=Senatur_Tarde_; integrated security=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Usuarios>(entity =>
            {
                ...
                entity.HasIndex(e => e.Senha)
                    .HasName("UQ__Usuarios__7ABB97315118DD33")
                    .IsUnique();
